...
if __name__ == '__main__':
    ...
    parser.add_argument('--reduction', type=str, default='mean', help='reduction method for circaFM embeddings, choose from mean or concat')
    ...
    parser.add_argument('--pretrained_model_path', type=str, default="saved_nnets/circadfm-small/best_model.pth", help='path to load pretrained weight')
    ...
    parser.add_argument('--seq_len', type=int, default=72, help='sequence length for each sample, currently only support 72 for circaFM')
